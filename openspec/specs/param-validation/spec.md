...
Enforce PARAM_SCHEMA bounds and type coercion on strategy parameters before they are passed to engine factory calls. This ensures that out-of-range parameters are silently corrected rather than causing runtime errors or unexpected behavior.
