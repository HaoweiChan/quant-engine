...
Client-side registry of technical indicators for the Data Hub: typed definitions, overlay vs pane classification, compute contracts, and multi-instance support without chart-component changes when adding new indicator types.
