...
Agent skill files that provide stage-aware domain knowledge for the strategy optimization loop. Includes a master orchestration skill defining the 5-stage loop with 5 reference files covering strategy types, stop diagnosis, statistical validity, position sizing, and regime detection.
