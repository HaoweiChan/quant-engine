...
Deployment pipeline for binding optimized parameter candidates to trading sessions. Handles the deploy action, deployment logging, stale-param detection, and backtest provenance resolution.
