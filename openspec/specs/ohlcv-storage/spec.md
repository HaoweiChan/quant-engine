...
Persist historical 1-minute OHLCV bar data to the database and provide a crawl pipeline for fetching data from broker APIs. Thicker timeframes are always aggregated on demand from 1-minute data — never stored separately.
