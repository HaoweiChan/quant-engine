...
Client-side tick-to-bar aggregation in the Zustand market data store, enabling real-time OHLCV bar construction from live tick streams without server round-trips.
