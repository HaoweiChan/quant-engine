...
Position Engine SHALL expose an `on_snapshot()` method as the sole entry point, called on every new bar/snapshot. Engine accepts policy objects via constructor instead of PyramidConfig.
