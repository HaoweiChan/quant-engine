...
Centralized secret management for all API keys and credentials. All secrets are retrieved from Google Secret Manager at runtime with process-lifetime caching. No secrets are stored on disk or in environment variables.
