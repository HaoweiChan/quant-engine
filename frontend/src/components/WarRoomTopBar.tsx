      ...
      <div className="flex items-center gap-4">
        {totalEquity !== undefined && (
          <div className="flex items-center gap-1.5">
            <span className="text-[9px]" style={{ color: colors.dim, fontFamily: "var(--font-mono)" }}>EQUITY</span>
            <span className="text-[12px] font-semibold" style={{ color: colors.text, fontFamily: "var(--font-mono)" }}>
        ...
        {marginRatio !== undefined && (
          <div className="flex items-center gap-1.5">
            <span className="text-[9px]" style={{ color: colors.dim, fontFamily: "var(--font-mono)" }}>MARGIN</span>
            <span className="text-[11px] font-semibold" style={{ color: marginColor, fontFamily: "var(--font-mono)" }}>
